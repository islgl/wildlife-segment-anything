...
def plot_val_study(file="", dir="", x=None):  # from utils.plots import *; plot_val_study()
    ...
    plot2 = False  # plot additional masks
    if plot2:
...
def plot_evolve(evolve_csv="path/to/evolve.csv"):  # from utils.plots import *; plot_evolve()
    # Plot evolve.csv hyp evolution masks
    ...
    print(f"Best masks from row {j} of {evolve_csv}:")
...
def plot_results(file="path/to/masks.csv", dir=""):
    ...
    for f in files:
        try:
            ...
            for i, j in enumerate([1, 2, 3, 4, 5, 8, 9, 10, 6, 7]):
                ...
                ax[i].plot(x, y, marker=".", label=f.stem, linewidth=2, markersize=8)  # actual masks
